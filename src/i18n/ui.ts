...
export const ui = {
  pt: {
    ...
    contact: {
      title: "Precisa de um engenheiro que entregue do sensor ao dashboard?",
      description:
        "Disponível para projetos full stack, plataformas IoT, integrações e consultoria de arquitetura. Resposta em até 24 horas.",
      channelLinkedin: "LinkedIn",
      channelWhatsapp: "WhatsApp",
      channelEmail: "E-mail",
      channelLocation: "Localização",
      copy: "Copiar",
      copied: "Copiado",
      formHead: "Form. 01 / Mensagem",
      nameLabel: "Nome",
  ...
  es: {
    ...
    contact: {
      title: "¿Necesitas un ingeniero que entregue del sensor al dashboard?",
      description:
        "Disponible para proyectos full stack, plataformas IoT, integraciones y consultoría de arquitectura. Respuesta en hasta 24 horas.",
      channelLinkedin: "LinkedIn",
      channelWhatsapp: "WhatsApp",
      channelEmail: "Correo",
      channelLocation: "Ubicación",
      copy: "Copiar",
      copied: "Copiado",
      formHead: "Form. 01 / Mensaje",
      nameLabel: "Nombre",
      ...
      messagePlaceholder: "Contexto, alcance, plazos y stack involucrada.",
      send: "Enviar por correo",
      direct: "Mensaje directo",
      errRequired: "Campo obligatorio.",
      errEmail: "Ingresa un correo válido.",
      errMax: "Máximo 1000 caracteres.",
    },
    blogLabel: "Blog",
    blogTitle: "Escritos",
  ...
  en: {
    ...
    contact: {
      title: "Need an engineer who delivers from sensor to dashboard?",
      description:
        "Available for full-stack projects, IoT platforms, integrations and architecture consulting. Reply within 24 hours.",
      channelLinkedin: "LinkedIn",
      channelWhatsapp: "WhatsApp",
      channelEmail: "Email",
      ...
      messagePlaceholder: "Context, scope, deadlines and stack involved.",
      send: "Send via email",
      direct: "Direct message",
      errRequired: "Required field.",
      errEmail: "Enter a valid email.",
      errMax: "Maximum 1000 characters.",
    },
    blogLabel: "Blog",
    blogTitle: "Writings",
